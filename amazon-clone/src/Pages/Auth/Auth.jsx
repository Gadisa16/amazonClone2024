      ...
      <div className={classes.login_container}>
        ...
        <form action="">
          ...
          <button type="submit" name="signin" onClick={authHandler} className={classes.login_signInButton}>
            {loading.signIn ? (<ScaleLoader color="yellow" height={10} style={load_style}/>) : ("Sign In")}
          </button>
        </form>
        <p>
        ...
        <button type="submit" name="signup" onClick={authHandler} className={classes.login_registerButton}>
          {loading.signUp ? (<ScaleLoader height={10} style={load_style}/>) : ("Create Your Amazon Account")}
        </button>
